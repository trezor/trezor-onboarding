                            ...
                            device!.features!.major_version === 1 && (
                                <React.Fragment>
                                    ...
                                    <OptionsList
                                        ...
                                        onSelect={(value: number) => { this.props.recoveryActions.setWordsCount(value); }}
                                    />
                ...
                { this.getStatus() === 'select-advanced-recovery' && (
                    <React.Fragment>
                        ...
                        <OptionsList
                            ...
                            selectedAccessor="value"
                            onSelect={(value: boolean) => { this.props.recoveryActions.setAdvancedRecovery(value); }}
                        />
                        ...
                        <React.Fragment>
                            ...
                            <SelectWrapper>
                                <Select
                                    ...
                                    noOptionsMessage={({ inputValue }: { inputValue: string}) => `word "${inputValue}" does not exist in words list`}
