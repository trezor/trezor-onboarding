...
const LineWord = styled.div`
    ...
    /* transition-delay: ${props => 500 * props.order}ms; */
    /* opacity: ${props => (props.showWords ? 1 : 0)} */
`;
...
const TrezorLogoVertical = () => (
    <svg style={{ height: '10%' }} id="Vrstva_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 121.7 86.3">
    ...
    <Card>
        <CardInner>
            <CardFront>
                ...
                <FrontRight>
                    <FrontHeader>YOUR PERSONAL <br /> RECOVERY CARD</FrontHeader>
