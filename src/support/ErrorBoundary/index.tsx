            ...
            return (
                <ErrorWrapper>
                    ...
                    <ControlsWrapper>
                        {/* {
                            !isDevelopment() && (
                                <Button variant="success" onClick={() => ErrorLogService.showReportDialog()}>Report problem</Button>
                            )
                        } */}
                        <Button variant="info" onClick={() => this.reload()}>Reload application</Button>
                    </ControlsWrapper>
                    <Attribution>
