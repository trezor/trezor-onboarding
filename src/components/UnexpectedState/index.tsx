...
import { ConnectActions, ConnectReducer } from 'types/connect';
import { OnboardingActions } from 'types/onboarding';
import { AnyStepDisallowedState } from 'types/steps';
...
const UnexpectedStateCommon: FunctionComponent<React.PropsWithChildren<UnexpectedStateCommonProps>> = ({ children }) => (
    <Wrapper>
        {children}
    </Wrapper>
);
...
const IsDeviceRequestingPin: FunctionComponent<IsDeviceRequestingPinProps> = ({ connectActions, uiInteraction }) => (
    <React.Fragment>
        <H2>
